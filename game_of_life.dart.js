...
z=this.Jc()
if(z==null){if(init.globalState.yc!=null&&init.globalState.i2.x4(init.globalState.yc.iP)&&init.globalState.Ai===!0&&init.globalState.yc.Gx.X5===0)H.Vj(P.FM("Program exited with open ReceivePorts."))
y=init.globalState
...
static:{"^":"zX,QZ,RV,lF,os,M9,jF,Zt,vj,bO"}},
vs:{
"^":"a;YM,t9<,O1",
...
if(typeof a==="string"&&!0){z=this.Mb
return z==null?!1:z[a]!=null}else if((a&0x3ffffff)===a){y=this.cG
...
if(typeof a==="string"&&!0){z=this.Mb
if(z==null)return!1
return z[a]!=null}else if((a&0x3ffffff)===a){y=this.cG
if(y==null)return!1
...
if(y==null)return!1
return y[b]!=null}else return this.PR(b)},"$1","gdj",2,0,20],
...
for(z=new H.a7(b,8,0,null);z.G();)this.h(0,z.Ff)},
bu:function(a){return P.WE(this,"{","}")},
aN:function(a,b){var z
...
$isiP:true,
static:{"^":"Oj,Vp,A2,p2,ch,QC,Px,DU,kc,Gi,Fz,cR,RM,Ke,Cg,Nr,bm,FI,Kz,ek,yf,Fk",Wu:function(a,b){var z=new P.iP(a,b)
z.RM(a,b)
...
DG:{
"^":"ea;",
gwd:function(a){var z=a._dartDetail
if(z!=null)return z
...
"%":"HTMLImageElement"},
Mi:{
"^":"qE;fg:height%,zv:valueAsNumber=,R:width%",
$iscv:true,
$isD0:true,
"%":"HTMLInputElement"},
El:{
...
z=W.qc(a.target)
y=H.VM(new P.hL(a.clientX,a.clientY),[null])
x=J.Yq(J.Ah(z))
w=y.x
v=x.x
...
if(typeof x!=="number")return H.s(x)
t=H.VM(new P.hL(w-v,u-x),[H.Kp(y,0)])
...
else return"DOMMouseScroll"},"$1","Ox",2,0,6],
...
fa:{
"^":"a;x>,y>",
giO:function(a){return(this.x^this.y)>>>0},
...
v=z+1
u=x+1
return[S.pL(y,w),S.pL(z,w),S.pL(v,w),S.pL(y,x),S.pL(v,x),S.pL(y,u),S.pL(z,u),S.pL(v,u)]},
static:{"^":"Hd,V4",pL:function(a,b){var z
if(Math.abs(a)>2048||Math.abs(b)>2048)return new S.fa(a,b)
else if(!$.aH().x4(a)){$.aH().u(0,a,P.L5(null,null,null,null,null))
z=new S.fa(a,b)
J.kW($.aH().t(0,a),b,z)
return z}else if(!$.aH().t(0,a).x4(b)){z=new S.fa(a,b)
J.kW($.aH().t(0,a),b,z)
return z}else return J.UQ($.aH().t(0,a),b)}}},
Iv:{
"^":"a;LU,A5",
Ux:function(a){var z=new S.tM(P.Ls(null,null,null,null),P.Ls(null,null,null,null))
a.hK().aN(0,new S.FD(this,a,z))
return z}},
FD:{
"^":"Tp:8;a,b,c",
...
z=a.ci()
y=this.b.yq
z=H.VM(new H.U5(z,y.gdj(y)),[H.Kp(H.VM(new H.TN(),[H.Kp(z,0)]),0)])
x=z.gB(z)
if(x!==3)z=x===2&&y.tg(0,a)
else z=!0
this.c.u(0,a,z)
return}},
tM:{
"^":"a;yq,MR",
hK:function(){var z=P.Ls(null,null,null,null)
this.yq.aN(0,new S.T5(z))
return z},
t:function(a,b){return this.yq.tg(0,b)},
u:function(a,b,c){var z,y
z=this.yq
y=this.MR
if(c===!0){z.h(0,b)
y.Rz(0,b)}else{z.Rz(0,b)
y.h(0,b)}},
bu:function(a){return"Generation{aliveCell: "+H.d(this.yq)+", deadCells: "+H.d(this.MR)+"}"}},
T5:{
"^":"Tp:8;a",
...
z={}
y=C.fK.aM(window)
H.VM(new W.xC(0,y.J6,y.fA,W.VF(V.Lv()),y.el),[H.Kp(y,0)]).DN()
y=C.IU.aM(window)
H.VM(new W.xC(0,y.J6,y.fA,W.VF(V.Lv()),y.el),[H.Kp(y,0)]).DN()
y=C.cy.aM(window)
H.VM(new W.xC(0,y.J6,y.fA,W.VF(V.N4()),y.el),[H.Kp(y,0)]).DN()
y=J.uX($.Ye())
H.VM(new W.xC(0,y.J6,y.fA,W.VF(V.xU()),y.el),[H.Kp(y,0)]).DN()
y=J.Vg($.Yh())
H.VM(new W.xC(0,y.J6,y.fA,W.VF(V.Tw()),y.el),[H.Kp(y,0)]).DN()
z.a=P.rT(C.RT,new V.em())
y=J.GW($.KS())
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new V.Lb(z)),y.el),[H.Kp(y,0)]).DN()
y=J.AL($.KS())
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new V.QA(z)),y.el),[H.Kp(y,0)]).DN()
y=J.kg($.KS())
H.VM(new W.xC(0,y.J6,y.fA,W.VF(new V.Cv(z)),y.el),[H.Kp(y,0)]).DN()
y=window
C.ol.y4(y)
C.ol.ne(y,W.VF(V.Km()))},"$0","KW",0,0,1],
ht:[function(a){var z
$.Zo().Gv()
z=$.nG
if(z>0)$.z9=P.rT(P.k5(0,0,0,P.y(0,z-C.jn.Y(J.XH(a),$.nG)),0,0),new V.BD())},"$1","Km",2,0,7],
Ie:function(){$.Yr().textContent=C.jn.bu($.kX().ey)
$.Ey().textContent=C.jn.bu($.kX().AT.yq.X5)},
yb:[function(a){var z,y,x
z=J.XH(J.W3($.Ye()))
if(z<0){$.Z4().textContent="Stop"
y=-1}else if(z>=10){$.Z4().textContent="Max"
y=1000}else{H.E0(2)
H.E0(z)
y=0.25*Math.pow(2,z)
$.Z4().textContent=H.d(y)+"x"}$.nG=C.jn.Z(1000,y)
x=window
C.ol.y4(x)
C.ol.ne(x,W.VF(V.Km()))},"$1","xU",2,0,8],
mg:[function(a){var z=$.kX()
z.toString
z.AT=new S.tM(P.Ls(null,null,null,null),P.Ls(null,null,null,null))
z.ey=0
z.Gn.V1(0)
V.Ie()},"$1","Tw",2,0,8],
...
y.toString
x=J.RE(z)
x.sR(z,C.CD.yu(C.CD.UD(y.offsetWidth))-30)
y=$.eS()
y.toString
x.sfg(z,C.CD.yu(C.CD.UD(y.offsetHeight))-30)
J.eX($.jY().style,"block")
y=$.kX()
z=y.Gn
z.V1(0)
z.QR(y.AT)},"$1","Lv",2,0,8],
Ej:[function(a){var z,y,x,w,v,u
z=J.RE(a)
if(!J.de(z.gwd(a),0)){z=z.gwd(a)
...
x=z.Gn
w=x.WB
w=P.y(0.125,P.J(w*(y<0?-0.5:2)*y,8))
P.JS("Scale: "+H.d(w))
v=x.bJ
u=w/x.WB
J.q5(v,u,u)
x.WB=w
x.V1(0)
x.QR(z.AT)},"$1","N4",2,0,9],
RX:function(){return P.SZ(C.Hk,new V.el())},
wJ:{
"^":"Tp:10;",
$0:function(){}},
em:{
...
Lb:{
"^":"Tp:8;a",
$1:function(a){var z=V.RX()
this.a.a=z
return z}},
QA:{
"^":"Tp:8;a",
$1:function(a){return this.a.a.Gv()}},
Cv:{
"^":"Tp:8;a",
$1:function(a){return this.a.a.Gv()}},
BD:{
...
v=C.jn.yu(C.CD.yu(Math.ceil(x/w/z.EL)))
z=$.kX().Gn
w=J.OB(z.KH)
x=z.WB
if(typeof w!=="number")return w.V()
u=C.jn.yu(C.CD.yu(Math.ceil(w/x/z.EL)))
t=v*u*0.01
for(s=0;s<t;++s){r=S.pL(y.j1(v),y.j1(u))
z=$.kX()
x=z.AT
x.yq.h(0,r)
x.MR.Rz(0,r)
z.Gn.h5(r)
$.Yr().textContent=C.jn.bu($.kX().ey)
$.Ey().textContent=C.jn.bu($.kX().AT.yq.X5)}}}},1],["","",,O,{
"^":"",
by:{
"^":"a;KH,bJ,EL,Wi,wX,zc,WB,eA,UO,p0",
MI:function(a){return this.p0.$1(a)},
at:function(a,b){return this.p0.$2$startCell(a,b)},
u:function(a,b,c){return c===!0?this.TR(b,"red"):this.TR(b,"white")},
...
C.Tr.ng(x)
x.lineWidth=z*y
x.strokeStyle=this.zc
x.stroke()
x.closePath()},
h5:function(a){return this.TR(a,"red")},
V1:function(a){var z,y,x,w,v
z=this.bJ
J.RE(z).Q4(z)
y=J.DO(this.KH)
...
z=this.zc
if(z!==this.wX){y=this.EL
x=0
while(!0){w=J.DO(this.KH)
v=this.WB
if(typeof w!=="number")return w.V()
if(!(x<w/v))break
w=J.OB(this.KH)
...
u.moveTo(x,0)
u.lineTo(x,w/v)
u.lineWidth=this.Wi*this.WB
u.stroke()
x+=y}t=0
while(!0){w=J.OB(this.KH)
v=this.WB
if(typeof w!=="number")return w.V()
if(!(t<w/v))break
w=J.DO(this.KH)
...
u.stroke()
t+=y}}},
QR:function(a){a.MR.aN(0,new O.tF(this))
a.yq.aN(0,new O.NW(this))},
b1:[function(a){var z=this.H7(a)
this.eA=z
return z},"$1","gO6",2,0,23],
UB:[function(a){this.eA=null
this.mW(this.H7(a))
this.UO=null},"$1","gV2",2,0,23],
Ac:[function(a){var z
if(this.eA!=null){z=this.H7(a)
if(!J.de(this.UO,z))this.mW(z)}},"$1","gGC",2,0,23],
mW:function(a){var z,y
if(this.p0!=null&&!J.de(this.UO,a)){this.UO=a
z=J.de(a,this.eA)
y=this.UO
if(z)this.MI(y)
else this.at(y,this.eA)}},
...
return S.pL(w,C.CD.Z(z,x*y))},
lP:function(a){var z
this.KH=a
z=J.GW(a)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(this.gO6()),z.el),[H.Kp(z,0)]).DN()
z=J.AL(this.KH)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(this.gV2()),z.el),[H.Kp(z,0)]).DN()
z=J.G0(this.KH)
H.VM(new W.xC(0,z.J6,z.fA,W.VF(this.gGC()),z.el),[H.Kp(z,0)]).DN()
this.bJ=J.PB(a,"2d")
this.V1(0)}},
tF:{
"^":"Tp:8;a",
$1:function(a){return this.a.TR(a,"white")}},
NW:{
"^":"Tp:8;b",
$1:function(a){return this.b.TR(a,"red")}},
wE:{
"^":"a;Jg,Gn,AT,ey,v5",
G0:[function(a,b){var z,y
z=this.AT
if(b==null){y=!z.yq.tg(0,a)
z.u(0,a,y)
this.v5=y}else z.u(0,a,this.v5)
z=this.Gn
if(this.AT.yq.tg(0,a))z.TR(a,"red")
else z.TR(a,"white")},function(a){return this.G0(a,null)},"Sl","$2$startCell","$1","gxU",2,3,24,16],
t:function(a,b){return this.AT.yq.tg(0,b)},
...
I.$lazy($,"_cache","V4","aH",function(){return P.L5(null,null,null,null,null)})
I.$lazy($,"canvasPanel","z2","eS",function(){return document.querySelector("#canvasPanel")})
I.$lazy($,"canvas","qN","jY",function(){return document.querySelector("#canvas")})
I.$lazy($,"gridPresenter","SU","kX",function(){var z,y
z=new O.by(null,null,10,1,"white","white",1,null,null,null)
z.lP($.jY())
y=new O.wE(new S.Iv(null,null),z,new S.tM(P.Ls(null,null,null,null),P.Ls(null,null,null,null)),0,!0)
z.p0=y.gxU()
return y})
I.$lazy($,"clearButton","X4","Yh",function(){return document.querySelector("#clearButton")})
I.$lazy($,"randomButton","ZH","KS",function(){return document.querySelector("#randomButton")})
I.$lazy($,"speed","LC","Ye",function(){return document.querySelector("#speed")})
I.$lazy($,"speedValue","hR","Z4",function(){return document.querySelector("#speedValue")})
I.$lazy($,"generationValue","Ps","Yr",function(){return document.querySelector("#generationValue")})
I.$lazy($,"cellsValue","Ug","Ey",function(){return document.querySelector("#cellsValue")})
I.$lazy($,"generationTimer","z9","Zo",function(){return P.rT(C.RT,new V.wJ())})


init.metadata=[{func:"n9",void:true,args:[{func:"X0",void:true}]},{func:"X0",void:true},{func:"Ib",ret:P.a2,args:[null,null]},{func:"bX",ret:P.KN,args:[null]},{func:"E0",ret:P.a2,args:[P.a,P.a]},{func:"ZY",ret:P.KN,args:[P.a]},{func:"AN",ret:P.qU,args:[W.D0]},{func:"c7",args:[P.FK]},{func:"aB",args:[null]},{func:"mc",args:[W.J6]},{func:"NT"},{func:"bh",args:[null,null]},{func:"TS",args:[null,P.qU]},{func:"uO",args:[P.qU]},{func:"xO",args:[{func:"X0",void:true}]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"BG",args:[null],opt:[null]},{func:"Uf",ret:P.a2},{func:"bb",args:[null,P.mE]},{func:"Lc",ret:P.a2,args:[P.a]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:P.qU,args:[P.KN]},{func:"XF",args:[W.Aj]},{func:"eQ",args:[S.fa],named:{startCell:S.fa}},{func:"ZH",args:[P.KN]},{func:"iR",args:[P.KN,null]},];$=null
...
if(typeof dartMainRunner==="function"){dartMainRunner(function(b){H.Rq(V.KW(),b)},[])}else{(function(b){H.Rq(V.KW(),b)})([])}})
})()
