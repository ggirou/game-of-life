...
class XMain extends PolymerElement {
  int lifeTime = 1000;
  DivElement canvasPanel;
  CanvasElement canvas;

  InputElement clearButton, randomButton, speed;
  SpanElement speedValue, generationValue, cellsValue;
  ...
  XMain.created() : super.created() {
    ...
    canvasPanel = shadowRoot.querySelector("#canvasPanel");
    canvas = shadowRoot.querySelector("#canvas");
    
    clearButton = shadowRoot.querySelector("#clearButton");
    randomButton = shadowRoot.querySelector("#randomButton");
    speed = shadowRoot.querySelector("#speed");
    speedValue = shadowRoot.querySelector("#speedValue");
    generationValue = shadowRoot.querySelector("#generationValue");
    cellsValue = shadowRoot.querySelector("#cellsValue");

    gridPresenter = new GridPresenter(new Engine(), new Grid(canvas));
